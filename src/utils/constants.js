import { GAME_CLIENT_UPDATE_SERVER_URL, SOCKET_CONNECTION_URL, PROGRAM_UPDATE_SERVICE_URL, ACCOUNT_URL, FORUM_URL } from '../config';
import packagejson from '../../package.json';

export { GAME_CLIENT_UPDATE_SERVER_URL, SOCKET_CONNECTION_URL, PROGRAM_UPDATE_SERVICE_URL, ACCOUNT_URL, FORUM_URL };
